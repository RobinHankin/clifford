...
@hankin2022_clifford.  In this short document I show how free algebras
...
`freealg` package [@hankin2022_freealg].  The dot object is a
(trivial) `S4` object of class `dot`:
