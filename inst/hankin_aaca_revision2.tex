...
doubles.  \textcolor{blue}{The {\tt STL map} class is used for
  ...
  $k$-vector will have ${n\choose k}\lesssim n^{-1/2}2^n/\sqrt{n}$
  possible coefficients, so operations will again be
  $\mathcal{O}(n)$.}  Similar techniques are used in the {\tt spray}
