...
```{r lor100}
unlist(lorenz(1,1,1,100))
unlist(lorenz(1,1,1.0001,100))
```


```{r lor1000,cache=TRUE}
unlist(lorenz(1,1,1,1000))
unlist(lorenz(1,1,1.0001,1000))
```


```{r lor10000,cache=TRUE}
unlist(lorenz(1,1,1,10000))
unlist(lorenz(1,1,1.0001,10000))
```

```{r lor100000,cache=TRUE}
unlist(lorenz(1,1,1,100000))
unlist(lorenz(1,1,1.0001,100000))
```

```{r useduallorenz10, cache=TRUE}
lorenz(1,1,1+eps,10)
```

```{r useduallorenz100, cache=TRUE}
lorenz(1,1,1+eps,100)
```

```{r useduallorenz10000, cache=TRUE}
lorenz(1,1,1+eps,10000)
```
