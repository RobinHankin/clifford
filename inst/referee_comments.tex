...
\textcolor{blue}{If one is not familiar with the R language, such
  constructs might appear unnatural.  However, close reading of the
  manuscript reveals that this particular syntax is a {\em formal}
  creation method.  Along with operator overloading, this is a
  commonly-used feature of C++ and R.  It is included in many
  introductory texts, including those cited in the submission.}
...
\textcolor{blue}{Firstly, I must take issue with the somewhat weighted
  ...
  others.  It is simply incorrect to characterise R as a non-symbolic
  language.}
