...
{\mathbf c}$ spanning ${\mathbf x}\in\mathbb{R}^3$ and wish to write
${\mathbf x}=\alpha {\mathbf a}+\beta {\mathbf b}+\gamma {\mathbf c}$
for some $\alpha,\beta,\gamma\in\mathbb{R}$.  The traditional
