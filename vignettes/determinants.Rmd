...
vignette: >
  %\VignetteIndexEntry{determinants}
...
`clifford` R package, following @hestenes1987.  The methods shown here
are not computationally efficient compared with bespoke linear algebra
